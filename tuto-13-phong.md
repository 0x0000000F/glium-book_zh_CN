# Blinn-phong shading 此内容尚未翻译

Our current lighting model is a bit primitive.
We are going to modify it to use what is called _Blinn-Phong shading_.
...
![A schema of what's happening](Source/Tuto-13-Phong/tuto-13-specular.png)
...
![Result](Source/Tuto-13-Phong/tuto-13-result.png) ![Result](Source/Tuto-13-Phong/tuto-13-result2.png)
...
> 原地址: <https://github.com/glium/glium/blob/master/book/tuto-13-phong.md>
